  ...
  return <section className="tetris-screen" aria-label="MD북스 전자종이 테트리스">
    ...
    <div className="tetris-stage">
      <aside className="tetris-side-panel">
        <div className="tetris-score-panel"><span><small>SCORE</small><b>{game.score.toLocaleString()}</b></span><div><span><small>LINES</small><b>{game.lines}</b></span><span><small>LV</small><b>{game.level}</b></span></div></div>
